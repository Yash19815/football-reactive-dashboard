...
export function PlayerHeatmap({ position }: PlayerHeatmapProps) {
  ...
  return (
    <div className="bg-slate-800 rounded-xl p-6 shadow-lg border border-slate-700">
      <div
        className="relative bg-gradient-to-b from-green-700 to-green-800 rounded-lg overflow-hidden"
      ...
      >
        ...
        >
          ...
          {/* Penalty arcs */}
          <path
            d="M 18.5 23.16 A 9.15 9.15 0 0 1 18.5 44.84"
            fill="none"
            stroke="white"
            strokeWidth="0.3"
          />
          <path
            d="M 86.5 23.16 A 9.15 9.15 0 0 0 86.5 44.84"
            fill="none"
            stroke="white"
            strokeWidth="0.3"
          />
